...
const Cart = () => {
    ...
    const removeCartItem = (prod) => {
        ...
        axios
            .delete(
                `https://rich-blue-anemone-yoke.cyclic.app/api/v1/cart/remove/${prod._id}`
            )
            .then((response) => {
    ...
    const handlePayment = () => {
        ...
        axios.delete(`https://rich-blue-anemone-yoke.cyclic.app/api/v1/cart/delete/${loggedUser._id}`)
            .then((res) => {
