...
const Cart = () => {
    ...
    const removeCartItem = (prod) => {
        ...
        axios
            .delete(
                `https://orange-red-hermit-crab-yoke.cyclic.app/api/v1/cart/remove/${prod._id}`
            )
            .then((response) => {
    ...
    const handlePayment = () => {
        ...
        axios.delete(`https://orange-red-hermit-crab-yoke.cyclic.app/api/v1/cart/delete/${loggedUser._id}`)
            .then((res) => {
